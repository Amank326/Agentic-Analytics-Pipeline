...
-- Query 2: Monthly Sales & Profit Growth Trends (MoM Growth Diff using LAG Window Function)
SELECT 
...
-- Query 5: Sub-Category Anomaly Detection (Deficit transactions conditional counts)
SELECT 
    category,
    sub_category,
